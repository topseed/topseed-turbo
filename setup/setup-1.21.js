...
loadjs([ // load bowser
	'https://cdn.rawgit.com/puppetmaster3/smoothState.js/master/deps/bowser.min.js'
			...
			if(bowser.msie) {
				...
				console.log('-not IE, good for you')
...
loadjs([
	...
	,'https://cdn.rawgit.com/puppetmaster3/smoothState.js/master/release/SP-1.20.js'
...
function onAppReady(pinit) {
	if(appReady) {
		...
		setTimeout(function() {//wait 20 milliseconds then recheck
			console.log('.')
			onAppReady(pinit)
		} ,20)
	}//else
