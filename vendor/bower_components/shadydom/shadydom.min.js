...
*/
'use strict';function n(a,b){return{index:a,l:[],o:b}}
function aa(a,b,c,d){var e=0,h=0,g=0,f=0,k=Math.min(b-e,d-h);if(0==e&&0==h)a:{for(g=0;g<k;g++)if(a[g]!==c[g])break a;g=k}if(b==a.length&&d==c.length){for(var f=a.length,l=c.length,m=0;m<k-g&&ba(a[--f],c[--l]);)m++;f=m}e+=g;h+=g;b-=f;d-=f;if(!(b-e||d-h))return[];if(e==b){for(b=n(e,0);h<d;)b.l.push(c[h++]);return[b]}if(h==d)return[n(e,b-e)];k=e;g=h;d=d-g+1;f=b-k+1;b=Array(d);for(l=0;l<d;l++)b[l]=Array(f),b[l][0]=l;for(l=0;l<f;l++)b[0][l]=l;for(l=1;l<d;l++)for(m=1;m<f;m++)if(a[k+m-1]===c[g+l-1])b[l][m]=
b[l-1][m-1];else{var q=b[l-1][m]+1,y=b[l][m-1]+1;b[l][m]=q<y?q:y}k=b.length-1;g=b[0].length-1;d=b[k][g];for(a=[];0<k||0<g;)k?g?(f=b[k-1][g-1],l=b[k-1][g],m=b[k][g-1],q=l<m?l<f?l:f:m<f?m:f,q==f?(f==d?a.push(0):(a.push(1),d=f),k--,g--):q==l?(a.push(3),k--,d=l):(a.push(2),g--,d=m)):(a.push(3),k--):(a.push(2),g--);a.reverse();b=void 0;k=[];for(g=0;g<a.length;g++)switch(a[g]){case 0:b&&(k.push(b),b=void 0);e++;h++;break;case 1:b||(b=n(e,0));b.o++;e++;b.l.push(c[h]);h++;break;case 2:b||(b=n(e,0));b.o++;
e++;break;case 3:b||(b=n(e,0)),b.l.push(c[h]),h++}b&&k.push(b);return k}function ba(a,b){return a===b};var p=window.ShadyDOM||{};p.T=!(!Element.prototype.attachShadow||!Node.prototype.getRootNode);var t=Object.getOwnPropertyDescriptor(Node.prototype,"firstChild");p.i=!!(t&&t.configurable&&t.get);p.K=p.force||!p.T;function u(a){return"ShadyRoot"===a.N}function v(a){a=a.getRootNode();if(u(a))return a}var w=Element.prototype,ca=w.matches||w.matchesSelector||w.mozMatchesSelector||w.msMatchesSelector||w.oMatchesSelector||w.webkitMatchesSelector;
...
U.removeAttribute=wa;U.cloneNode=xa;U.importNode=ya;U.addEventListener=za;U.removeEventListener=Aa;U.U=Ba;U.V=Ca;U.dispatchEvent=Da;var Ea="function"===typeof Event?Event:function(a,b){b=b||{};var c=document.createEvent("Event");c.initEvent(a,!!b.bubbles,!!b.cancelable);return c};function V(a){this.root=a;this.u="slot"}
V.prototype.F=function(){var a;if(Fa(this.root)){a=[];for(var b=0,c=this.root.host.firstChild;c;c=c.nextSibling)a[b++]=c;for(var b=[],c=Ga(this.root),d=0,e=c.length,h;d<e&&(h=c[d]);d++){var g=void 0,f,k=h,l=a,m=k.__shady.assignedNodes;m&&Ha(k,!0);k.__shady.assignedNodes=[];for(var q=!1,y=!1,r=0,L=l.length;r<L;r++){f=l[r];var C;if(C=f){var G=f;C=(C=k.getAttribute("name"))?C.trim():"";G=(G=G.getAttribute&&G.getAttribute("slot"))?G.trim():"";C=G==C}C&&(f.__shady.D!=k&&(q=!0),y=k,y.__shady.assignedNodes.push(f),
f.__shady.assignedSlot=y,l[r]=void 0,y=!0)}if(!y)for(l=k.childNodes,r=0;r<l.length;r++)f=l[r],f.__shady.D!=k&&(q=!0),L=k,L.__shady.assignedNodes.push(f),f.__shady.assignedSlot=L;if(m){for(f=0;f<m.length;f++)m[f].__shady.D=null;k.__shady.assignedNodes.length<m.length&&(q=!0)}m=k.__shady.assignedNodes;k.__shady.h=[];for(f=0;f<m.length&&(g=m[f]);f++)if(g.localName&&"slot"==g.localName){if(l=g.__shady.h)for(r=0;r<l.length;r++)k.__shady.h.push(l[r])}else k.__shady.h.push(m[f]);q&&Ia(this,k);(g=(g=h.parentNode)&&
g.__shady&&g.__shady.root)&&Fa(g)&&b.push(g)}for(c=0;c<a.length;c++)if(h=a[c])h.__shady=h.__shady||{},h.__shady.assignedSlot=void 0,(d=I.parentNode(h))&&U.removeChild.call(d,h);a=b}else a=[];return a};function Ha(a,b){var c=a.__shady.assignedNodes;if(c)for(var d=0;d<c.length;d++){var e=c[d];b&&(e.__shady.D=e.__shady.assignedSlot);e.__shady.assignedSlot===a&&(e.__shady.assignedSlot=null)}}
function Ia(a,b){U.dispatchEvent.call(b,new Ea("slotchange"));b.__shady.assignedSlot&&Ia(a,b.__shady.assignedSlot)}V.prototype.v=function(a){return!a.__shady.assignedSlot};var Ja={};function W(a,b){if(a!==Ja)throw new TypeError("Illegal constructor");a=document.createDocumentFragment();a.__proto__=W.prototype;a.N="ShadyRoot";T(b);T(a);b.shadowRoot=a;a.host=b;a.g=!1;a.C=!1;a.f=new V(a);a.update();return a}W.prototype=Object.create(DocumentFragment.prototype);W.prototype.update=function(){var a=this;this.g||(this.g=!0,ga(function(){return Ka(a)}))};
function Ka(a){if(a.g){for(var b=a;a;){a.g&&(b=a);a:{var c;c=a;a=c.host.getRootNode();if(u(a))for(var d=c.host.childNodes,e=0;e<d.length;e++)if(c=d[e],c.localName&&"slot"==c.localName)break a;a=void 0}}b._render()}}W.prototype._render=function(){this.C=this.g=!1;this.m||La(this);this.m=!1;this.F();Ma(this.host,Na(this,this.host));for(var a=Ga(this),b=0,c=a.length,d,e;b<c&&(d=a[b]);b++)e=d.parentNode,e!==this.host&&e!==this&&Ma(e,Na(this,e))};W.prototype.F=function(){for(var a=this.f.F(),b=0;b<a.length;b++)a[b]._render()};
function La(a){var b=a.b;if(b)for(var c=0,d;c<b.length;c++)d=b[c],d.getRootNode()!==a&&Ha(d);b=a.b=a.f.root.querySelectorAll("slot");for(a=0;a<b.length;a++)d=b[a],d.__shady=d.__shady||{},T(d),T(d.parentNode)}function Na(a,b){var c=[];b=(b.__shady&&b.__shady.root||b).childNodes;for(var d=0;d<b.length;d++){var e=b[d];if(e.localName&&"slot"==e.localName)for(var h=e.__shady.h||(e.__shady.h=[]),g=0;g<h.length;g++){var f=h[g];a.v(e,f)&&c.push(f)}else c.push(e)}return c}
W.prototype.v=function(a,b){return this.f.v(a,b)};function Ma(a,b){for(var c=I.childNodes(a),d=aa(b,b.length,c,c.length),e=0,h=0,g;e<d.length&&(g=d[e]);e++){for(var f=0,k;f<g.l.length&&(k=g.l[f]);f++)I.parentNode(k)===a&&U.removeChild.call(a,k),c.splice(g.index+h,1);h-=g.o}for(e=0;e<d.length&&(g=d[e]);e++)for(h=c[g.index],f=g.index;f<g.index+g.o;f++)k=b[f],U.insertBefore.call(a,k,h),c.splice(f,0,k)}function Fa(a){return!(!a.b||!a.b.length)}function Ga(a){a.b||La(a);return a.b}
W.prototype.addEventListener=function(a,b,c){"object"!==typeof c&&(c={capture:!!c});c.B=this;this.host.addEventListener(a,b,c)};W.prototype.removeEventListener=function(a,b,c){"object"!==typeof c&&(c={capture:!!c});c.B=this;this.host.removeEventListener(a,b,c)};W.prototype.getElementById=function(a){return this.querySelector("#"+a)};var Oa=W.prototype;R(Oa,P,!0);R(Oa,Q,!0);function Pa(a){var b=a.__shady&&a.__shady.parentNode,c,d=v(a);if(b||d){c=Qa(a);if(b){a.__shady=a.__shady||{};b.__shady=b.__shady||{};a===b.__shady.firstChild&&(b.__shady.firstChild=a.__shady.nextSibling);a===b.__shady.lastChild&&(b.__shady.lastChild=a.__shady.previousSibling);var e=a.__shady.previousSibling,h=a.__shady.nextSibling;e&&(e.__shady=e.__shady||{},e.__shady.nextSibling=h);h&&(h.__shady=h.__shady||{},h.__shady.previousSibling=e);a.__shady.parentNode=a.__shady.previousSibling=a.__shady.nextSibling=
void 0;void 0!==b.__shady.childNodes&&(b.__shady.childNodes=null)}if(e=d){for(var g,e=Ga(d),h=0;h<e.length;h++){var f=e[h],k;a:{for(k=f;k;){if(k==a){k=!0;break a}k=k.parentNode}k=void 0}if(k)for(f=f.assignedNodes({flatten:!0}),k=0;k<f.length;k++){g=!0;var l=f[k],m=I.parentNode(l);m&&U.removeChild.call(m,l)}}e=g}b=b&&d&&b.localName===d.f.u;if(e||b)d.m=!1,X(d)}Ra(a);return c}function Sa(a,b,c){if(a=a.__shady&&a.__shady.j)b&&a.addedNodes.push(b),c&&a.removedNodes.push(c),Ta(a)}
function Ua(a){if(a&&a.nodeType){a.__shady=a.__shady||{};var b=a.__shady.G;void 0===b&&(u(a)?b=a:b=(b=a.parentNode)?Ua(b):a,document.documentElement.contains(a)&&(a.__shady.G=b));return b}}function Va(a,b,c){var d,e=c.f.u;if(a.nodeType!==Node.DOCUMENT_FRAGMENT_NODE||a.__noInsertionPoint)a.localName===e&&(T(b),T(a),d=!0);else for(var e=a.querySelectorAll(e),h=0,g,f;h<e.length&&(g=e[h]);h++)f=g.parentNode,f===a&&(f=b),f=Va(g,f,c),d=d||f;return d}
function Wa(a){return(a=a&&a.__shady&&a.__shady.root)&&Fa(a)}function Ra(a){if(a.__shady&&void 0!==a.__shady.G)for(var b=a.childNodes,c=0,d=b.length,e;c<d&&(e=b[c]);c++)Ra(e);a.__shady=a.__shady||{};a.__shady.G=void 0}function Qa(a){a=a.parentNode;if(Wa(a))return X(a.__shady.root),!0}function X(a){a.C=!0;a.update()}function Xa(a,b){"slot"===b?Qa(a):"slot"===a.localName&&"name"===b&&(a=v(a))&&a.update()}function Ya(a,b,c){var d=[];Za(a.childNodes,b,c,d);return d}
...
function $a(a,b,c){if(c){var d=c.__shady&&c.__shady.parentNode;if(void 0!==d&&d!==a||void 0===d&&I.parentNode(c)!==a)throw Error("Failed to execute 'insertBefore' on 'Node': The node before which the new node is to be inserted is not a child of this node.");}if(c===b)return b;b.nodeType!==Node.DOCUMENT_FRAGMENT_NODE&&((d=b.__shady&&b.__shady.parentNode)?(Sa(d,null,b),Pa(b)):(b.parentNode&&U.removeChild.call(b.parentNode,b),Ra(b)));var d=c,e=v(a),h;e&&(b.__noInsertionPoint&&!e.C&&(e.m=!0),h=Va(b,a,
e))&&(e.m=!1);if(a.__shady&&void 0!==a.__shady.firstChild)if(ra(a),a.__shady=a.__shady||{},void 0!==a.__shady.firstChild&&(a.__shady.childNodes=null),b.nodeType===Node.DOCUMENT_FRAGMENT_NODE){for(var g=b.childNodes,f=0;f<g.length;f++)sa(g[f],a,d);b.__shady=b.__shady||{};g=void 0!==b.__shady.firstChild?null:void 0;b.__shady.firstChild=b.__shady.lastChild=g;b.__shady.childNodes=g}else sa(b,a,d);var g=h,f=e&&e.f.u||"",k=b.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&!b.__noInsertionPoint&&f&&b.querySelector(f);
h=k&&k.parentNode.nodeType!==Node.DOCUMENT_FRAGMENT_NODE;((k=k||b.localName===f)||a.localName===f||g)&&e&&X(e);(e=Wa(a))&&X(a.__shady&&a.__shady.root);if(!(e||k&&!h||a.__shady.root||d&&u(d.parentNode)&&d.parentNode.g)){if(c&&(d=v(c))){var l;if(c.localName===d.f.u)a:{d=c.assignedNodes({flatten:!0});e=Ua(c);h=0;for(g=d.length;h<g&&(l=d[h]);h++)if(e.v(c,l))break a;l=void 0}else l=c;c=l}l=u(a)?a.host:a;c?U.insertBefore.call(l,b,c):U.appendChild.call(l,b)}Sa(a,b);return b}
function ab(a,b){if(a.ownerDocument!==document)return U.importNode.call(document,a,b);var c=U.importNode.call(document,a,!1);if(b){a=a.childNodes;b=0;for(var d;b<a.length;b++)d=ab(a[b],!0),c.appendChild(d)}return c};function bb(){this.b=!1;this.addedNodes=[];this.removedNodes=[];this.s=new Set}function Ta(a){a.b||(a.b=!0,fa(function(){cb(a)}))}function cb(a){if(a.b){a.b=!1;var b=a.takeRecords();b.length&&a.s.forEach(function(a){a(b)})}}bb.prototype.takeRecords=function(){if(this.addedNodes.length||this.removedNodes.length){var a=[{addedNodes:this.addedNodes,removedNodes:this.removedNodes}];this.addedNodes=[];this.removedNodes=[];return a}return[]};
function db(a,b){a.__shady=a.__shady||{};a.__shady.j||(a.__shady.j=new bb);a.__shady.j.s.add(b);var c=a.__shady.j;return{P:b,S:c,R:a,takeRecords:function(){return c.takeRecords()}}}function eb(a){var b=a&&a.S;b&&(b.s.delete(a.P),b.s.size||(a.R.__shady.j=null))}
...
var jb={get composed(){!1!==this.isTrusted&&void 0===this.w&&(this.w=gb[this.type]);return this.w||!1},composedPath:function(){this.H||(this.H=hb(this.__target,this.composed));return this.H},get target(){return ib(this.currentTarget,this.composedPath())},get relatedTarget(){if(!this.I)return null;this.J||(this.J=hb(this.I,!0));return ib(this.currentTarget,this.J)},stopPropagation:function(){Event.prototype.stopPropagation.call(this);this.A=!0},stopImmediatePropagation:function(){Event.prototype.stopImmediatePropagation.call(this);
this.A=this.L=!0}};function kb(a){function b(b,d){b=new a(b,d);b.w=d&&!!d.composed;return b}da(b,a);b.prototype=a.prototype;return b}var lb={focus:!0,blur:!0};function mb(a,b,c){if(c=b.a&&b.a[a.type]&&b.a[a.type][c])for(var d=0,e;(e=c[d])&&a.target!==a.relatedTarget&&(e.call(b,a),!a.L);d++);}
function nb(a){var b=a.composedPath(),c;Object.defineProperty(a,"currentTarget",{get:function(){return c},configurable:!0});for(var d=b.length-1;0<=d;d--)if(c=b[d],mb(a,c,"capture"),a.A)return;Object.defineProperty(a,"eventPhase",{get:function(){return Event.AT_TARGET}});for(var e,d=0;d<b.length;d++)if(c=b[d],!d||c.shadowRoot&&c.shadowRoot===e)if(mb(a,c,"bubble"),c!==window&&(e=c.getRootNode()),a.A)break}
...
function pb(a,b,c){if(b){var d,e,h;"object"===typeof c?(d=!!c.capture,e=!!c.once,h=!!c.passive):(d=!!c,h=e=!1);var g=c&&c.B||this;if(b.c){if(-1<ob(b.c,g,a,d,e,h))return}else b.c=[];var f=function(d){e&&this.removeEventListener(a,b,c);d.__target||qb(d);var f;g!==this&&(f=Object.getOwnPropertyDescriptor(d,"currentTarget"),Object.defineProperty(d,"currentTarget",{get:function(){return g},configurable:!0}));if(d.composed||-1<d.composedPath().indexOf(g))if(d.target===d.relatedTarget)d.eventPhase===Event.BUBBLING_PHASE&&
d.stopImmediatePropagation();else if(d.eventPhase===Event.CAPTURING_PHASE||d.bubbles||d.target===g){var h="object"===typeof b&&b.handleEvent?b.handleEvent(d):b.call(g,d);g!==this&&(f?(Object.defineProperty(d,"currentTarget",f),f=null):delete d.currentTarget);return h}};b.c.push({node:this,type:a,capture:d,once:e,passive:h,W:f});lb[a]?(this.a=this.a||{},this.a[a]=this.a[a]||{capture:[],bubble:[]},this.a[a][d?"capture":"bubble"].push(f)):(this instanceof Window?U.U:U.addEventListener).call(this,a,f,
c)}}function rb(a,b,c){if(b){var d,e,h;"object"===typeof c?(d=!!c.capture,e=!!c.once,h=!!c.passive):(d=!!c,h=e=!1);var g=c&&c.B||this,f=void 0;b.c&&(e=ob(b.c,g,a,d,e,h),-1<e&&(f=b.c.splice(e,1)[0].W,b.c.length||(b.c=void 0)));(this instanceof Window?U.V:U.removeEventListener).call(this,a,f||b,c);f&&lb[a]&&this.a&&this.a[a]&&(a=this.a[a][d?"capture":"bubble"],f=a.indexOf(f),-1<f&&a.splice(f,1))}}function sb(){for(var a in lb)window.addEventListener(a,function(a){a.__target||(qb(a),nb(a))},!0)}
function qb(a){a.__target=a.target;a.I=a.relatedTarget;if(p.i){var b=Object.getPrototypeOf(a);if(!b.hasOwnProperty("__patchProto")){var c=Object.create(b);c.X=b;x(c,jb);b.__patchProto=c}a.__proto__=b.__patchProto}else x(a,jb)}var tb=kb(window.Event),ub=kb(window.CustomEvent),vb=kb(window.MouseEvent);function wb(a){var b=a.getRootNode();u(b)&&Ka(b);return a.__shady&&a.__shady.assignedSlot||null}
...
function Z(a,b){for(var c=Object.getOwnPropertyNames(b),d=0;d<c.length;d++){var e=c[d],h=Object.getOwnPropertyDescriptor(b,e);h.value?a[e]=h.value:Object.defineProperty(a,e,h)}};if(p.K){window.ShadyDOM={inUse:p.K,patch:function(a){return a},isShadyRoot:u,enqueue:ga,flush:F,settings:p,filterMutations:fb,observeChildren:db,unobserveChildren:eb,nativeMethods:U,nativeTree:I};window.Event=tb;window.CustomEvent=ub;window.MouseEvent=vb;sb();var Gb=window.customElements&&window.customElements.nativeHTMLElement||HTMLElement;Z(window.Node.prototype,yb);Z(window.Window.prototype,xb);Z(window.Text.prototype,zb);Z(window.DocumentFragment.prototype,Ab);Z(window.Element.prototype,Cb);Z(window.Document.prototype,
Db);window.HTMLSlotElement&&Z(window.HTMLSlotElement.prototype,Bb);Z(Gb.prototype,Fb);p.i&&(S(window.Node.prototype),S(window.Text.prototype),S(window.DocumentFragment.prototype),S(window.Element.prototype),S(Gb.prototype),S(window.Document.prototype),window.HTMLSlotElement&&S(window.HTMLSlotElement.prototype));window.ShadowRoot=W};
}).call(self);
